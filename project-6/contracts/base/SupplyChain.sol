...
import "../core/Ownable.sol";
  ...
  struct Item {
    ...
    address payable  originSellerID; // Metamask-Ethereum address of the Farmer
    ...
    address payable  deliveryAgentID;  // Metamask-Ethereum address of the Distributor
  ...
  // Define a function 'prepareItems' that allows a seller to mark an item 'Prepared'
  function prepareItems(uint _upc, address payable  _originSellerID, string  memory _originSellerName, string memory _originSellerInformation, string memory _productNotes, uint _productPrice)  public {
// Add the new item 
    items[_upc] = Item({
      sku: sku,
      upc: _upc,
  ...
  function buyItems(uint _upc) public payable
  // Call modifier to check if upc has passed previous supply chain stage
  forSale(_upc)
  ...
  function shipItems(uint _upc,address payable  _deliveryAgentID) public 
  // Call modifier to check if upc has passed previous supply chain stage
    sold(_upc)
  // Call modifier to verify caller of this function
            verifyCaller(items[_upc].originSellerID)
  {
    ...
    // Define a function 'DeliverItems' that allows a Delivey to mark an item 'Delivered'
    ...
    onlyDeliveryAgent()
{
  ...
  string  memory  originSellerInformation
   ) 
  {
